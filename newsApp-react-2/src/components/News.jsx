...
export class News extends Component {
  ...
  async componentDidMount(){
    ...
    let apiUrl = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=24030685c7384ad49895e3e45df73beb&pageSize=${this.props.pageSize}`;
  ...
  handleNextButton = async() =>{
    ...
    if(!(this.state.page + 1 > Math.ceil(this.state.totalResults / this.props.pageSize))){
      let apiUrl = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=24030685c7384ad49895e3e45df73beb&page=${this.state.page + 1}&pageSize= ${this.props.pageSize}`;
      let promise = await fetch(apiUrl);
      let data = await promise.json();
      this.setState({
